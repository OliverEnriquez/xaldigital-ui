...
const Product = () => {
  ...
  const onChangePurchase = (qty, price) => {
    setPurchaseProduct(qty * price);
  };
        ...
        <Modal.Body>
          <Form>
            ...
            <FormGroup>
              ...
              <Input
                type="number"
                onChange={(e) => onChangePurchase(purchase, quantity)}
              ></Input>
              <Input type="number" value={purchaseProduct}></Input>
            </FormGroup>
            <FormGroup>
              <Label>Imagen</Label>
              <Input
