          ...
          <Card>
            ...
            <CardBody className="">
              <Row style={{ marginBottom: 20 }}>
                ...
                <Col lg="5" md="5" sm="5" xs="12" xxl="12" style={{ float: "right" }}>
                  <Label for="name" >Desde: </Label>
                  <DatePicker selected={startDate} onChange={(date: Date) => setStartDate(date)} style={{ maxWidth: 500 }} />
                </Col>
                <Col lg="5" md="5" sm="5" xs="12" xxl="12" style={{ float: "right" }}>
                  <Label for="name" >a: </Label>
                  <DatePicker selected={finalDate} onChange={(date: Date) => setFinalDate(date)} />
                </Col>
