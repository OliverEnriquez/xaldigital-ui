...
function ViewProduct(props) {
  ...
  function updateQty() {
    axios
      .post("http://localhost:8080/product/qty/" + qty + "/" + id)
      .then(() => {
        getProduct();
        handleCloseRemove();
        handleClose();
  ...
  function print() {
    ...
    mywindow.document.write(
      "<img src = 'https://culturacolectiva-cultura-colectiva-prod.cdn.arcpublishing.com/resizer/Msf6aRG54gOyN7KQiV6aHkBAxOg=/1024x768/filters:format(jpg):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/culturacolectiva/AY3FD3Q3XVCVTPTD53VEIZK2ZA.jpg'/>"
    );
    ...
    <div>
      ...
      <Modal show={showAdd} onHide={handleClose}>
        ...
        <Modal.Footer>
          ...
          <Button color="primary" onClick={updateQty}>
            Guardar
          </Button>
        </Modal.Footer>
      </Modal>
