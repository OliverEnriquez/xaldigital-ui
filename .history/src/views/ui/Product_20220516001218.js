...
const Product = () => {
  ...
  const viewPage = (idProduct) => {
    history("/viewProduct", { state: { id: idProduct } });
  };
    ...
    <div>
      <Row>
        <Col xs="12" md="12" lg="12">
          <img src="https://lh3.googleusercontent.com/d/1UTzm2e26TwOyd54PIehsGn405FKRA4A5=s220?authuser=0" />
          <Collapse in={open}>
