...
function ViewProduct(props) {
    ...
    axios
      ...
      .then(() => {
        axios
          ...
          .catch((error) => console.error("Error: " + error));
        getAlert("Hecho!", "success", "Se genero QR");
      })
  ...
  const purchaseProduct = () => {
    ...
    axios
      ...
      .then((response) => {
        updateQty(q);
        handleClose();
        getAlert("Hecho!", "success", "Se genero Compra");
      })
  ...
  const saleProduct = () => {
    const q = quantity - qty;
    axios
      .post("http://localhost:8080/sale/" + qty * sale + "/" + qty + "/" + id)
      .then((response) => {
        updateQty(q);
        handleCloseSale();
        getAlert("Hecho!", "success", "Se genero Venta");
      })
      .catch((error) => console.log("Error!", "danger", error));
  };
            ...
            <CardBody className="p-4">
              ...
              <Row style={{ float: "right" }}>
                <Col
                  ...
                  sm="12"
                  xs="12"
                  style={{ textAlign: "end", marginTop: 20, display: "flex" }}
                >
                  <Button
                    className="btn"
                    color="primary"
